...
test("Agent writer content uses slightly smaller scoped body typography", () => {
  assert.match(
    css,
    /div\.notion-agent-writer-ui :where\(div\[role="group"\]\.whenContentEditable\) \*\s*\{[\s\S]*?font-family: "Oxanium", "Pridi", "NotionRestyleBodyCJK", "Noto Sans SC", STKaiti, -apple-system,[\s\S]*?line-height: 1\.8em !important;/,
  );
  assert.match(
    css,
